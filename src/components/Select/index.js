...
const Select = ({
  ...
  label,
  type = "normal",
  /***  Une fonction de filtrage pour filtrer les options  ***/
  filter,
}) => {
  const [value, setValue] = useState();
  const [collapsed, setCollapsed] = useState(true);

  /***  Applique le filtre aux options si la fonction de filtrage est fournie  ***/
  ...
  const changeValue = (newValue) => {
    /***  Appelle la fonction onChange avec la nouvelle valeur sélectionnée  ***/
    onChange(newValue);
    setValue(newValue);
...
Select.propTypes = {
  ...
  /***  Propriété ajoutée pour la fonction de filtrage ***/
